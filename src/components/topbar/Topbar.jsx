                ...
                <div class="dropdown">
                    ...
                    <div className="dropdown-content">
                        ...
                        <select name="API" id="api">
                            <option value="valor1" selected><a href="#">API Interplayers Pedidos</a></option>
                            <option value="valor2" ><a href="#">API Interplayers Retornos</a></option>
                            <a href="#">API Interplayers</a>
